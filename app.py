...
from Coding.stockfish_gui.analysis_helpers import confidence_label, move_explanation, profile_params, trap_scan
...
class StockfishGUI:
    ...
    def _engine_panel(self, parent: ttk.Frame) -> None:
        ...
        noise_frame = ttk.Frame(tune)
        noise_frame.grid(row=1, column=3, sticky="ew", pady=(6, 0))
        ttk.Label(noise_frame, text="< less").pack(side=tk.LEFT)
        noise_scale = ttk.Scale(noise_frame, from_=0.0, to=0.5, variable=self.style_noise_var, orient=tk.HORIZONTAL)
        noise_scale.pack(side=tk.LEFT, fill=tk.X, expand=True)
        ttk.Label(noise_frame, text="more >").pack(side=tk.LEFT)
        ...
        dev_frame = ttk.Frame(tune)
        dev_frame.grid(row=2, column=1, sticky="ew", pady=(6, 0))
        ttk.Label(dev_frame, text="< less").pack(side=tk.LEFT)
        dev_scale = ttk.Scale(dev_frame, from_=0.0, to=1.0, variable=self.dev_weight_var, orient=tk.HORIZONTAL)
        dev_scale.pack(side=tk.LEFT, fill=tk.X, expand=True)
        ttk.Label(dev_frame, text="more >").pack(side=tk.LEFT)
        ...
        castle_frame = ttk.Frame(tune)
        castle_frame.grid(row=2, column=3, sticky="ew", pady=(6, 0))
        ttk.Label(castle_frame, text="< less").pack(side=tk.LEFT)
        castle_scale = ttk.Scale(castle_frame, from_=0.0, to=1.0, variable=self.castle_weight_var, orient=tk.HORIZONTAL)
        castle_scale.pack(side=tk.LEFT, fill=tk.X, expand=True)
        ttk.Label(castle_frame, text="more >").pack(side=tk.LEFT)
        ...
        center_frame = ttk.Frame(tune)
        center_frame.grid(row=3, column=1, sticky="ew", pady=(6, 0))
        ttk.Label(center_frame, text="< less").pack(side=tk.LEFT)
        center_scale = ttk.Scale(center_frame, from_=0.0, to=1.0, variable=self.center_pawn_weight_var, orient=tk.HORIZONTAL)
        center_scale.pack(side=tk.LEFT, fill=tk.X, expand=True)
        ttk.Label(center_frame, text="more >").pack(side=tk.LEFT)
        ...
        capture_frame = ttk.Frame(tune)
        capture_frame.grid(row=3, column=3, sticky="ew", pady=(6, 0))
        ttk.Label(capture_frame, text="< less").pack(side=tk.LEFT)
        capture_scale = ttk.Scale(capture_frame, from_=0.0, to=1.0, variable=self.capture_weight_var, orient=tk.HORIZONTAL)
        capture_scale.pack(side=tk.LEFT, fill=tk.X, expand=True)
        ttk.Label(capture_frame, text="more >").pack(side=tk.LEFT)
        ...
        check_frame = ttk.Frame(tune)
        check_frame.grid(row=4, column=1, sticky="ew", pady=(6, 0))
        ttk.Label(check_frame, text="< less").pack(side=tk.LEFT)
        check_scale = ttk.Scale(check_frame, from_=0.0, to=1.0, variable=self.check_weight_var, orient=tk.HORIZONTAL)
        check_scale.pack(side=tk.LEFT, fill=tk.X, expand=True)
        ttk.Label(check_frame, text="more >").pack(side=tk.LEFT)
        ...
        retreat_frame = ttk.Frame(tune)
        retreat_frame.grid(row=4, column=3, sticky="ew", pady=(6, 0))
        ttk.Label(retreat_frame, text="< less").pack(side=tk.LEFT)
        retreat_scale = ttk.Scale(retreat_frame, from_=0.0, to=1.0, variable=self.retreat_penalty_var, orient=tk.HORIZONTAL)
        retreat_scale.pack(side=tk.LEFT, fill=tk.X, expand=True)
        ttk.Label(retreat_frame, text="more >").pack(side=tk.LEFT)
        ...
        conversion_frame = ttk.Frame(tune)
        conversion_frame.grid(row=5, column=1, sticky="ew", pady=(6, 0))
        ttk.Label(conversion_frame, text="< less").pack(side=tk.LEFT)
        conversion_scale = ttk.Scale(conversion_frame, from_=0.0, to=1.0, variable=self.conversion_weight_var, orient=tk.HORIZONTAL)
        conversion_scale.pack(side=tk.LEFT, fill=tk.X, expand=True)
        ttk.Label(conversion_frame, text="more >").pack(side=tk.LEFT)
